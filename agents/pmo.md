...
- US/Task/Bug/Testの起票時は補助参照セクションの decision_record.md のdescription用テンプレートに従うこと
- Epic/Feature起票基準・description規約: 補助参照セクションの ticket_conventions.md を参照
...
- @vibes/docs/templates/decision_record.md — チケットdescription作成時

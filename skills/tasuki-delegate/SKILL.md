...
description: leader→subagentへのタスク委譲を支援する。4ロール（coder/tester/researcher/pmo）の委譲テンプレートを提供し、構造化された指示を即座に構成できる。
---
...
1. 委譲先ロールを選択する（coder/tester/researcher/pmo）
...
チケット操作（作成・更新・検索・US分解）・プロセス監査・ワークフロー相談を委譲する。
